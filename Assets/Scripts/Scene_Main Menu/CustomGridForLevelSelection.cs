...
[AddComponentMenu("NGUI/Interaction/CustomGridForLevelSelection")]
public class CustomGridForLevelSelection : UIWidgetContainer
{
    ...
    {
        /*
        if(Camera.main.pixelWidth < 800)
        {
            cellWidth = Camera.main.pixelWidth * 4 / 15;
            cellHeight = cellWidth * 11 / 10;
            return;
        }
        cellWidth = 200;
        cellHeight = 300;
        */
        ...
        //cellWidth = cellHeight = (int) (120 * (temp / 2.0 + 0.5));
        //cellWidth = cellHeight = (int)(240 / temp);
