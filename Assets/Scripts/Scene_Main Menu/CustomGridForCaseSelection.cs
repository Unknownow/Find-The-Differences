...
[AddComponentMenu("NGUI/Interaction/CustomGridForCaseSelection")]
public class CustomGridForCaseSelection : UIWidgetContainer
{
    ...
    private void Awake()
    {
        cellHeight = gameObject.GetComponent<UIPanel>().GetViewSize().x * 12 / 20;
    }
