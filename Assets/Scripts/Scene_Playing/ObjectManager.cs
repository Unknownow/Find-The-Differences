...
public class ObjectManager : MonoBehaviour {
    ...
    private StarsCount _starsCount;
    ...
    public void blurBackground(int index)
    {
        ...
        if (index == 0)
        {
            _blurBackground.GetComponent<UI2DSprite>().sprite2D = _pauseBackground;
            upperPanel.GetComponent<UISprite>().spriteName = "Sprite_Upper Panel";
        }
        else if (index == 1)
        {
            _blurBackground.GetComponent<UI2DSprite>().sprite2D = _nextLevelBackground;
            upperPanel.GetComponent<UISprite>().spriteName = "Sprite_Upper Panel";
        }
        else if (index == 2)
        {
            _blurBackground.GetComponent<UI2DSprite>().sprite2D = _timeoutBackground;
