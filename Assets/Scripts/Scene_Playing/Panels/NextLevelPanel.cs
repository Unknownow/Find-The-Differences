...
public class NextLevelPanel : MonoBehaviour {
    ...
    public void openNextLevelPanel()
    {
        ...
        _endGameText.GetChild(1).GetComponent<UILabel>().text = "Bonus golds: " + gameObject.GetComponent<LevelManager>().getBonusGoldForThisLevel().ToString();
        ...
        _livesManager.addGold(gameObject.GetComponent<LevelManager>().getBonusGoldForThisLevel());
    ...
    public void onDoubleGoldClick()
    {
        if (!_isDoubleGold)
        {
            ...
            PlayerPrefs.SetInt("Gold", PlayerPrefs.GetInt("Gold") + gameObject.GetComponent<LevelManager>().getBonusGoldForThisLevel());
        }
    }
}
