...
public class LivesAndDailyManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (PlayerPrefs.GetString("Time") == "")
        {
            ...
            resetTime();
            currentDailyDay = 1;
            PlayerPrefs.SetInt("Daily Bonus", currentDailyDay);
        }
        else
        {
    ...
    public void onCheckingTime()
    {
        ...
        {
            resetTime();
            currentDailyDay = PlayerPrefs.GetInt("Daily Bonus");
            currentDailyDay = (currentDailyDay + 1) % 7;
            if (currentDailyDay == 0)
                currentDailyDay = 7;
            PlayerPrefs.SetInt("Daily Bonus", currentDailyDay);
        }
    }
    ...
    public void increaseCurrentLives(int numOfLives)
    {
    ...
    {
        PlayerPrefs.SetInt("Hints", PlayerPrefs.GetInt("Hints") + numOfHints);
    }
    ...
    {
        PlayerPrefs.SetInt("Gold", PlayerPrefs.GetInt("Gold") + number);
    }
    ...
    public int getLastestLoginDay()
    {
        return PlayerPrefs.GetInt("Daily Bonus");
    }

    public int getCurrentDailyDay()
    {
        return currentDailyDay;
    }

    public int getNumOfHints()
    {
        return PlayerPrefs.GetInt("Hints");
    }
}
